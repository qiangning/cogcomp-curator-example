...
// 
...
public class NETaggerLevel1 extends SparseNetworkLearner
{
  ...
  static
  {
    _lcFilePath = NETaggerLevel1.class.getResource("NETaggerLevel1.lc");
    _lexFilePath = NETaggerLevel1.class.getResource("NETaggerLevel1.lex");
  }
  ...
  private static void loadInstance()
  {
    if (instance == null)
    {
      if (_lcFilePath == null)
      {
        throw new RuntimeException("Can't locate NETaggerLevel1.lc in the class path.");
      }
      if (_lexFilePath == null)
      {
        throw new RuntimeException("Can't locate NETaggerLevel1.lc in the class path.");
      }
      instance = (NETaggerLevel1) Learner.readLearner(_lcFilePath);
  ...
  {
    super(new SparseAveragedPerceptron(.05, 0, 30));
  ...
  {
    super("edu.illinois.cs.cogcomp.ner.LbjFeatures.NETaggerLevel1");
    isClone = true;
  }
  ...
  public void learn(Object example)
  {
    if (isClone)
    {
      if (!(example instanceof NEWord || example instanceof Object[]))
      {
        ...
        System.err.println("Classifier 'NETaggerLevel1(NEWord)' defined on line 373 of LbjTagger.lbj received '" + type + "' as input.");
  ...
  public static void main(String[] args)
  {
    ...
    {
      System.err.println("usage: edu.illinois.cs.cogcomp.ner.LbjFeatures.NETaggerLevel1 \\");
    ...
    NETaggerLevel1 classifier = new NETaggerLevel1();
  ...
  {
    public Parameters() { super((SparseNetworkLearner.Parameters) new NETaggerLevel1(false).getParameters()); }
  }
}
